...
> **当前版本：`2.0.10`。** 本版修复任务资料接续、相对路径召回和局部故障处理，并明确：把功能与体验做好，精简的是无效测试和冗余流程。取消独立的个人写作风格学习／模仿功能，通用习惯、记忆、SOP、能力、自我学习与进化都保留；升级不删除已有用户资料。支持 1.4.8、保留的本地 1.4.9 与 2.0.0—2.0.9 从原实例升级。电脑端看板保持现有设计，本版不包含桌面客户端试验。
